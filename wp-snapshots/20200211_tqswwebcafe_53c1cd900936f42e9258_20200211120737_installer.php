...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20200211_tqswwebcafe_53c1cd900936f42e9258_20200211120737_archive.zip';
	const ARCHIVE_SIZE		 = '67176682';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '53c1cd9-11120737';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v1.3.26==');
		self::log('----------------------------------------------------');
